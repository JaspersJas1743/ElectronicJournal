...
namespace ElectronicJournal.ViewModels
{
    public class AuthorizationVM : INotifyPropertyChanged
    {
        ...
        public AuthorizationVM()
        {
            ...
            //_authorize = Command.CreateCommand(action: async (obj) => await CheckData(obj));
            _moveToRegistration = Command.CreateCommand(action: obj => Navigation.Navigate(page: new Registration()));
            _moveToPasswordRecovery = Command.CreateCommand(action: obj => Navigation.Navigate(page: new PasswordRecovery()));
