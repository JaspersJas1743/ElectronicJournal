...
namespace ElectronicJournal.Resources.Windows
{
	public partial class MessageWindow : Window
	{
		...
		public static MessageWindowResult Show(string text, MessageWindowImage image, MessageWindowButton buttons)
		{
			MessageWindow window = CreateDefaultMessageWindow(text: text, image: image, buttons: buttons);
			window.ShowDialog();
			return window.DialogResult;
		}

		private static MessageWindow CreateDefaultMessageWindow(string text, MessageWindowImage image, MessageWindowButton buttons)
		{
		...
		public static MessageWindowResult ShowError(string text)
			=> Show(image: MessageWindowImage.Error, text: text, buttons: MessageWindowButton.OkCancel);

		public static MessageWindowResult ShowWarning(string text)
			=> Show(image: MessageWindowImage.Warning, text: text, buttons: MessageWindowButton.OkCancel);

		public static MessageWindowResult ShowInformation(string text)
			=> Show(image: MessageWindowImage.Information, text: text, buttons: MessageWindowButton.Ok);

		public static void ShowMessage(string text)
		{
			MessageWindow window = CreateDefaultMessageWindow(image: MessageWindowImage.Information, text: text, buttons: MessageWindowButton.None);
